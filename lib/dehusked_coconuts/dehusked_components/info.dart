...
class DehuskedInfo extends StatefulWidget {
  const DehuskedInfo({super.key});

  @override
  State<DehuskedInfo> createState() => _DehuskedInfoState();
}

class _DehuskedInfoState extends State<DehuskedInfo> {
  bool _loading = true;
  XFile? _image;
  List? _output;
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset("lib/images/dehusked.png")
              ],
            ),
          ),
          Column(
